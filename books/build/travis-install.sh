...
install_acl2() {
	...
	git clone https://github.com/ragerdl/acl2.git
	cd acl2
    case "$ACL2-CONFIG" in
		vanilla) make ACL2 LISP="$LISP" ;;
		h) make ACL2 LISP="$LISP" ACL2_HONS=t ;;
		p) make ACL2 LISP="$LISP" ACL2_PAR=t ;;
		*)
			echo "Unrecognised ACL2-CONFIG: '$ACL2-CONFIG'"
			exit 1
			;;
	esac
	...
	cd books
    case "$ACL2-CONFIG" in
		vanilla) make basic ACL2="../saved_acl2" ;;
		h) make basic ACL2="../saved_acl2h" ;;
		p) make basic ACL2="../saved_acl2p" ;;
	esac
}
